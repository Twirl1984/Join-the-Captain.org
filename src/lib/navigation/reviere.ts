...
export const REVIER_GRUPPEN: RevierGruppe[] = [
  ...
  },
  {
    ...
    reviere: [
      ...
      {
        id: "bohuslaen",
        label: "Bohuslän (Göteborg-Schären)",
        center: [58.05, 11.5],
        zoom: 9,
        bbox: [57.55, 11.0, 58.45, 12.1],
        haefen: [
          ...
          { name: "Åstol", lat: 58.132, lon: 11.611 },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    reviere: [
      {
        id: "kanaren",
        label: "Kanaren — Ost (Lanzarote/Fuerteventura)",
        center: [28.75, -13.85],
        zoom: 9,
        bbox: [28.0, -14.6, 29.5, -13.3],
        haefen: [
